...
Este projeto é composto por dois módulos principais: **backend** (API REST) e **frontend** (interface web). O é facilitar o gerenciamento de clientes, pets, atendimentos, serviços e caixa para petshops.
